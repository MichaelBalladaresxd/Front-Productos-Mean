  ...
  agregarProducto(){
    ...
    if(this.id !== null){
      ...
      this.productoService.editarProducto(this.id,PRODUCTO).subscribe(data => {
        this.toastr.info('Cambios Guardadoscon exito!', 'El producto fue editado con exito!');
        this.router.navigate(['/']);
      },error => {
        this.toastr.error('Problemas al editar Producto!', 'El producto no fue actualizado!');
      })
      ...
      this.productoService.guardarProducto(PRODUCTO).subscribe(data => {
        ...
        this.toastr.error('Problemas al agregar Producto!', 'El producto no fue agregado!');
